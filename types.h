...
enum ETritonReportIDTypes {
  ...
  ID_TRITON_HAPTIC_STREAM_STATUS_STATE = 0x44,
...
enum {
  STREAM_STATUS_BUFFER_OVERRUN = 1 << 0,
  STREAM_STATUS_STREAM_STOPPED = 1 << 1,
  STREAM_STATUS_NEEDS_MORE_DATA = 1 << 2,
  STREAM_STATUS_HAS_ENOUGH_DATA = 1 << 3,
  STREAM_STATUS_CONFIG_REJECTED_INVALID = 1 << 4,
  STREAM_STATUS_CONFIG_ACCEPTED = 1 << 5,
  STREAM_STATUS_CONFIG_REJECTED_ALREADY_RUNNING = 1 << 6,
  STREAM_STATUS_UNKNOWN_BIT_8 = 1 << 7
};
